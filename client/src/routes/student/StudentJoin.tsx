  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      persistStudentSession({
        ...
        storyOrder: data.storyOrder,
        hintsEnabledByStory: data.hintsEnabledByStory,
        breakUntil: data.breakUntil,
        breakStartTime: data.breakUntil ? Date.now() : undefined,
        story1Complete: !!data.story1CompletedAt,
        story2Complete: !!data.story2CompletedAt,
        recallUnlockAt: data.recallUnlockAt,
        story1: data.story1,
        story2: data.story2,
        tts1: data.tts1Url || '',
        tts2: data.tts2Url || '',
