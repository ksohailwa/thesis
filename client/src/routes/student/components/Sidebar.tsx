           ...
           activeBlankKey ? (
             <div>
               <p className="text-sm text-amber-800 mb-2">
                 Word: <span className="font-bold">{activeHintWord}</span>
               </p>
               <p className="text-xs text-amber-600 mb-3">
                 Used: {hints[activeHintWord!]?.used || 0} / 3
               </p>
               <button 
                 onClick={onGetHint}
                 className="w-full py-2 bg-white border border-amber-200 text-amber-700 rounded-lg text-sm font-semibold hover:bg-amber-100 transition"
               >
                 Get Hint
               </button>
