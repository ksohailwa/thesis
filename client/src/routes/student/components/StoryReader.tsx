...
export default function StoryReader({
  ...
  return (
    <div className="lg:col-span-3 space-y-6">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 leading-loose text-lg text-gray-800 font-serif">
            ...
            <div key={pIdx} className="mb-6 last:mb-0">
              {sentences.map((sentenceText, sIdx) => {
                ...
                const sentenceBlanks = allBlanks.filter(
                  (b) => b.paragraphIndex === pIdx && b.sentenceIndex === sIdx
                )
