...
router.post('/demo/join', async (_req, res) => {
  ...
  type Occurrence = { story: 'A' | 'B'; paragraphIndex: number; sentenceIndex: number };
  const schedule: Record<
    string,
    { baseline: Occurrence; learning: Occurrence; reinforcement: Occurrence; recall: Occurrence }
  > = {};
